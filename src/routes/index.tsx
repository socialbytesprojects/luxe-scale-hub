            ...
            <figure key={image.src}>
              ...
              >
                <img
                  ...
                  alt={image.alt}
                  loading="lazy"
                  className={`absolute inset-0 h-full w-full object-cover transition-transform duration-700 group-hover:scale-[1.02] ${index === 1 ? "object-[46%_center]" : "object-center"}`}
                />
              </button>
            </figure>
          ))}
